        ...
        <div class="card">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-xl-6 col-md-6 mb-4">
                <label class="form-label font-w600">Mức lương max:<span class="text-danger scale5 ms-2">*</span></label>
                <input type="text" class="form-control solid" placeholder="$" aria-label="name" />
              </div>
              <div class="col-xl-6 col-md-6 mb-4">
              ...
              <div class="col-xl-6 col-md-6 mb-4">
                <label class="form-label font-w600">Trình độ học vấn:<span class="text-danger scale5 ms-2">*</span></label>
            ...
            <div>
              <span>Status:<label class="radio-inline mx-3"><input type="radio" name="optradio" class="form-check-input" />
                  Active</label></span>
              <span><label class="radio-inline me-3"><input type="radio" name="optradio" class="form-check-input" />
